...
interface SystemFormProps {
  initialValues?: Partial<SystemFormValues>;
  prefilledValues?: Partial<SystemFormValues>;
...
export function SystemForm({
  ...
  const form = useForm<SystemFormValues>({
    ...
    defaultValues: { ...defaultSystemValues, ...initialValues },
  });

  // Apply prefilled values from PDF extraction (only fills empty fields, never overwrites user edits)
  useEffect(() => {
  ...
  // Reset full state when initialValues change (e.g. async-loaded edit page)
  useEffect(() => {
    if (initialValues) {
      form.reset({ ...defaultSystemValues, ...initialValues });
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
